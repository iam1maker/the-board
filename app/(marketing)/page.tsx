...
const MarketingPage = () => {
    return (
        <div className="flex items-center justify-center flex-col">
            ...
            >
                <div className="mb-4 flex items-center border shadow-sm p-4 bg-slate-100 text-amber-700 rounded-full uppercase">
         ...
         from-fuchsia-600 to-pink-600 text-white px-4 p-2 rounded-md pb-4 w-fit"
            ...
            >
                ...
                From high rises to the home offce, the way your team works is
